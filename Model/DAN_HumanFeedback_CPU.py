...
kUNK = '<unk>'
kPAD = '<pad>'
MODEL_PATH = 'cucumber_dan3.pt'
PARAM_PATH = 'cucumber_params3.pickle'
...
def batchify(batch):
    ...
    if three:
        q_batch = {'text': x1, 'len': torch.FloatTensor(question_len), 'labels': target_labels, 'guesses': guess_list}
    else:
...
def train(args, model, train_data_loader, dev_data_loader, accuracy, device):
    ...
    for idx, batch in enumerate(train_data_loader):
        ...
        for i in range(len(labels)):
            ...
            real_index = index[0].item()
            if real_index in guesses[i]:
                multiplier += guesses[i][real_index]
                print("Yay!")
                print(guesses[i][real_index])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dev-file', type=str, default='/media/amoldwin/OS/Users/amold/Work/CMSC470/nlp-hw-private/qanta.dev.json')
    parser.add_argument('--test-file', type=str, default='/media/amoldwin/OS/Users/amold/Work/CMSC470/nlp-hw-private/qanta.test.json')
